...
(function (HermesJS) {
    ...
    (function (Control) {
        ...
        (function (Action) {
             ...
             * @type {string}
             */
            Action.REQUEST_STREAM_ID = "requestStreamId";
            /**
             * Media is not supported action
             * @type {string}
             */
            Action.MEDIA_NOT_SUPPORTED = "mediaNotSupported";
            /**
             * Request header of media action
             * @type {string}
             */
            Action.REQUEST_MEDIA_HEADER = "requestMediaHeader";
            /**
             * Stream stopped (ended) action
             * @type {string}
             */
            Action.STOP_STREAM = "stopStream";
        })(Action = Control.Action || (Control.Action = {}));
